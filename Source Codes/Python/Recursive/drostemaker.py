# https://inventwithpython.com/recursion/chapter14.html

from PIL import Image


def makeDroste(baseImage, stopAfter=4):
...
recursiveImage = makeDroste('Klutuk.png')
recursiveImage.save('Klutuk-recursive.png')
recursiveImage.show()