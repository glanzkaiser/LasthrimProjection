...
plot(xs1, y, color=:red, xtick=pitick(a, b, 2; mode=:latex), 
	xlims=(-3,3), ylims=(-π,π),framestyle=:zerolines,
	linestyle=:solid,  linecolor=:red2,
	legend=:topleft, label=L"\sinh \ x", 
	bottom_margin=3mm,
	size=(800, 460), tickfontsize=10)

# First Derivative plot
plot!(xs1, ys1, label=L"D_{x} \sinh \ x = \cosh \ x",
	color=:blue2)

# Second Derivative plot
plot!(xs1, ys2, label=L"D^{2}_{x}  \sinh \ x = \sinh \ x", color=:green3)
