...
plot!([0.707106781,0.707106781],[0.707106781,0], linecolor=:green, linestyle=:solid)
#plot!(Plots.partialcircle(0,1//4*pi), color=:red, linewidth=2)
plot!(Plots.partialcircle(0,1//4*pi,10,0.7), color=:red, linewidth=2)
     
annotate!([
	   (0.66,-0.01, (a, 20, :red)),
           (0.21,0.1, ("t", 10, :red)),
	   (0.2,-0.1, ("O (0,0)", 10, :red)),
           (0.71,-0.1, ("B", 10, :red)),
	   (0.37,0.46, ("D", 10, :red)),
           (1.18,-0.08, ("A(1,0)", 10, :red)),
           (-0.1,1.03, ("(0,1)", 10, :red)),
           (0.77,0.77, (L"C", 10, :red))])

scatter!([1], [0], color = "red", label="", markersize = 5)
scatter!([0.707106781], [0.707106781], color = "red", label="", markersize = 5)
scatter!([0.7], [0], color = "red", label="", markersize = 5)
