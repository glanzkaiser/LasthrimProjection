...
annotate!([(0.4,-0.1, (L"-2", 10, :black))])
annotate!([(0.6,0, (L"|", 17, :black))])
annotate!([(0.6,-0.1, (L"0", 10, :black))])
annotate!([(0.8,0, (L"|", 17, :black))])
annotate!([(0.8,-0.1, (L"2", 10, :black))])
annotate!([(0.4,0.1, (L"0", 10, :black))])
annotate!([(0.6,0.1, (L"0", 10, :black))])
annotate!([(0.35,0.1, (L"+", 10, :black))])
annotate!([(0.5,0.1, (L"-", 10, :red))])
...
annotate!([(0.4,0, (L"|", 17, :black))])
annotate!([(0.4,-0.1, (L"-\sqrt{2}", 10, :black))])
annotate!([(0.6,0, (L"|", 17, :black))])
annotate!([(0.6,-0.1, (L"0", 10, :black))])
annotate!([(0.8,0, (L"|", 17, :black))])
annotate!([(0.8,-0.1, (L"\sqrt{2}", 10, :black))])
annotate!([(0.4,0.1, (L"0", 10, :black))])
annotate!([(0.6,0.1, (L"0", 10, :black))])
annotate!([(0.8,0.1, (L"0", 10, :black))])
