...
diffeqv = Eq(v(t).diff(t), 0); string(diffeqv)
diffeqw = Eq(w(t).diff(t), -g); string(diffeqw)
...
println("Assume there is no air resistance -> r=0")

println("")
println("The horizontal and vertical components of the velocity : ")
